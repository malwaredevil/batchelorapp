...
replace_once(quality, 'source("../../routes/agentphone.ts")', 'source("../routes/agentphone.ts")')
replace_once(quality, 'source("../../routes/elaine-email.ts")', 'source("../routes/elaine-email.ts")')
replace_once(
    quality,
