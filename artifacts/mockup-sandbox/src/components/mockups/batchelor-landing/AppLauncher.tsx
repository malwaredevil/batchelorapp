...
/* ---- Modular config: apps render from this array, so new apps drop in here ---- */
const APPS = [
  {
    id: "pottery",
    name: "Pottery",
    image: "/__mockup/images/pottery-collection.png",
  ...
  },
  {
    id: "quilting",
    name: "Quilting",
    image: "/__mockup/images/quilting-collection.png",
          ...
          <section className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
              {APPS.map((app) => (
                <Card
                  key={app.id}
                  className="group overflow-hidden border-border bg-card shadow-sm hover:shadow-md transition-all duration-200 flex flex-col cursor-pointer"
                >
