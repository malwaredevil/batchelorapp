...
function StatusBar() {
  return (
    <div
      className="flex items-center justify-between px-5 shrink-0 bg-slate-900"
      style={{ height: 28 }}
    >
...
export function BatchelorHub() {
  return (
    <div
      className="flex flex-col w-full h-screen bg-slate-950 overflow-hidden"
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-6 space-y-4">
        ...
        <div className="space-y-3">
          ...
          >
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, #1C1007 0%, #7B3F00 40%, #D97706 100%)",
              }}
            />
            <div className="absolute inset-0 flex items-end p-4">
              <div className="flex-1 text-left">
                <p className="text-amber-200 text-[11px] font-semibold uppercase tracking-widest">
                  Collection
                </p>
                <h2 className="text-white text-[20px] font-bold leading-tight">
                  My Pottery
                </h2>
                <p className="text-amber-400 text-[12px] mt-0.5">
                  163 pieces catalogued
                </p>
              </div>
          ...
          >
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, #0C1A0C 0%, #1A5C2A 40%, #16A34A 100%)",
              }}
            />
            <div className="absolute inset-0 flex items-end p-4">
              <div className="flex-1 text-left">
                ...
                <p className="text-emerald-400 text-[12px] mt-0.5">
                  46 fabrics · 1 quilt in progress
                </p>
              </div>
              <div className="text-right">
                <span style={{ fontSize: 52 }}>🧵</span>
          ...
          <div className="grid grid-cols-4 gap-2">
            {[
              ...
              >
                ...
                <span className="text-[10px] text-slate-300 font-medium text-center leading-tight whitespace-pre-line">
                  {label}
                </span>
              </button>
            ))}
        ...
        <div>
          ...
          <div className="space-y-2">
            {[
              {
                icon: "🏺",
                label: "Added Celadon Bowl",
                sub: "Pottery · 2 hours ago",
                color: "#D97706",
              },
              {
                icon: "🌸",
                label: "3 fabrics bulk-added",
                sub: "Quilting · Yesterday",
                color: "#16A34A",
              },
              {
                icon: "🧵",
                label: "Garden Dreams layout saved",
                sub: "Quilting · 2 days ago",
                color: "#2563EB",
              },
            ].map(({ icon, label, sub, color }) => (
              <div
                key={label}
                className="flex items-center gap-3 rounded-2xl px-3 py-2.5 bg-white/5"
              >
                <div
        ...
        <div className="grid grid-cols-3 gap-2">
          {[
            ...
            <div
              key={label}
              className="rounded-2xl py-3 px-2 text-center bg-white/5"
            >
              <p className="text-[22px] font-bold text-white">{value}</p>
              <p className="text-[10px] text-slate-500 leading-tight whitespace-pre-line mt-0.5">
                {label}
              </p>
            </div>
          ))}
