...
export function FabricDetail() {
  return (
    <div
      className="flex flex-col w-full h-screen bg-slate-50 overflow-hidden relative"
    ...
    >
      ...
      <div className="relative shrink-0" style={{ height: 280 }}>
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, #2D4A6B 0%, #6B9AC4 50%, #A8C5E2 100%)",
          }}
        >
          {/* Pattern simulation */}
          ...
          <div className="absolute bottom-8 right-12 text-4xl opacity-20">
            🌸
          </div>
        </div>
        ...
        <div className="px-4 pt-3 pb-24">
          ...
          <div className="flex items-start justify-between mb-1">
            <div className="flex-1">
              ...
              <p className="text-[13px] text-slate-400 mt-0.5">
                Moda Fabrics · Garden Dreams line
              </p>
            </div>
          ...
          <div className="mt-4 flex flex-wrap gap-1.5">
            {tags.map((tag) => (
              <span
                key={tag}
                className="px-2.5 py-1 bg-white border border-slate-200 rounded-full text-[11px] font-medium text-slate-600 shadow-sm"
              >
                {tag}
              </span>
            ))}
          ...
          <div className="mt-4 bg-white rounded-2xl p-4 border border-slate-100 shadow-sm">
            <div className="flex items-center gap-1.5 mb-2">
              ...
              <span className="text-[12px] font-semibold text-violet-500 uppercase tracking-wide">
                AI Description
              </span>
            </div>
            <p className="text-[13px] text-slate-600 leading-relaxed">
              A deep navy cotton fabric featuring large-scale floral motifs in
              soft dusty blues and cream. The flowing botanical print evokes a
              romantic garden aesthetic, ideal for quilt centres, statement
              blocks, or backing fabric.
            </p>
          </div>
