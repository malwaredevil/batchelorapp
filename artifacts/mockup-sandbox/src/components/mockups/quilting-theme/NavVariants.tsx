...
function HeaderB() {
  ...
  const apps = [
    { id: "launcher", label: "Batchelor Hub", sub: "All your collections" },
    { id: "pottery",  label: "Batchelor Pottery", sub: "163 pieces" },
    { id: "quilting", label: "Ashley's Quilting", sub: "48 fabrics", active: true },
  ];
  return (
    <header className="border-b border-border bg-background/90 backdrop-blur-md relative">
      <div className="mx-auto flex h-16 max-w-6xl items-center gap-4 px-6">
        ...
        <div className="relative shrink-0">
          ...
          {open && (
            <div className="absolute top-full left-0 mt-1.5 w-60 rounded-xl border border-border bg-background shadow-lg z-50 overflow-hidden">
              {apps.map((app) => (
                <button
                  key={app.id}
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Click the pill to switch between apps. Slack, Linear, Vercel team picker.</p>
            </div>
          </div>
          <div className="rounded-xl border border-border overflow-hidden shadow-sm">
            <HeaderB />
