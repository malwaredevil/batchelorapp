...
const RULES: WeatherRule[] = [
  {
    match: /thunder|storm/i,
    emoji: "⛈️",
    bg: "bg-indigo-100 dark:bg-indigo-950/50",
  },
  {
    match: /snow|sleet|blizzard|flurr/i,
    emoji: "❄️",
  ...
  {
    match: /fog|mist|haze/i,
    emoji: "🌫️",
    bg: "bg-slate-100 dark:bg-slate-800/50",
  },
  {
    match: /wind|breez|gale/i,
    emoji: "🌬️",
    bg: "bg-teal-100 dark:bg-teal-950/50",
  },
  {
    match: /partly|partial|scattered/i,
    emoji: "⛅",
    bg: "bg-amber-50 dark:bg-amber-950/30",
  },
  {
    match: /cloud|overcast/i,
    emoji: "☁️",
    bg: "bg-slate-100 dark:bg-slate-800/50",
  },
...
export function formatTempRangeF(
  maxC: number | null | undefined,
  minC: number | null | undefined,
): string | null {
  if (maxC == null && minC == null) return null;
