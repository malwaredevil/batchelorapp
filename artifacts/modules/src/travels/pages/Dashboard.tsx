    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        ...
        <StatCard
          ...
          href="/travels/trips?status=completed"
        />
        <StatCard
          icon={<Calendar className="w-5 h-5" />}
          label="Upcoming"
          value={statsLoading ? "—" : (stats?.upcomingTrips ?? 0)}
          href="/travels/trips?status=booked"
        />
        <StatCard
      ...
      {stats?.nextTrip && nextTripCountdown !== null && (
        <Link href={`/travels/trips/${stats.nextTrip.id}`} className="block mb-6">
                ...
                <CardContent className="p-0">
                  ...
                  {groupedTrips.completed.length > 5 && (
                    <div className="px-4 py-3">
                      <Link href="/travels/trips?status=completed">
