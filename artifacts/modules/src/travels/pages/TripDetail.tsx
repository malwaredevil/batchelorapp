...
import { SortableSection } from "@/travels/components/trip-detail/sortable-section";
import {
  CardShell,
  DragHandle,
...
import {
  ...
  InlineTextareaField,
  InlineDateField,
} from "@/travels/components/InlineField";
import {
  Tooltip,
  TooltipTrigger,
  TooltipContent,
...
import {
  ...
  formatTempRangeC,
  formatTempRangeF,
} from "@/travels/lib/weather-icons";
import { TripLocationMap } from "@/travels/components/TripLocationMap";
import { DocTypeTrainingDialog } from "@/travels/components/DocTypeTrainingDialog";
...
export default function TripDetail({ id }: { id: number }) {
  ...
  const uploadTripDocument = useUploadTripDocument();
  ...
  const handleUploadConfirm = async () => {
    ...
    try {
      await uploadTripDocument.mutateAsync({
        id,
        data: { file: pendingFile, title: pendingTitle.trim() || undefined },
      });
      invalidate();
