...
export default [
  {
    ignores: [
      ...
      "artifacts/modules/src/magnets/pages/collection-compare.test.ts",
      "artifacts/modules/src/magnets/pages/bulk-add-queue.test.ts",
      "artifacts/modules/src/magnets/pages/image-editor-transform.test.ts",
      "artifacts/modules/src/quilting/lib/photo-recognition-status.test.ts",
