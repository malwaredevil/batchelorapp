...
export const ListOrnamentsResponse = zod.object({
  ...
  "descriptionGenerated": zod.boolean().optional().describe('True when description is an AI-generated stand-in because no legible box-back text was found (false for manual, verbatim, or catalog text).'),
  "acquiredAt": zod.string().nullish(),
  "dominantColors": zod.array(zod.string()).optional(),
  "motifs": zod.array(zod.string()).optional(),
...
export const GetOrnamentResponse = zod.object({
  ...
  "origin": zod.string().nullish(),
  "aiDescription": zod.string().nullish(),
  "description": zod.string().nullish().describe('Verbatim text transcribed from the printed description on the back of the ornament\'s box (distinct from aiDescription, which is AI-authored).'),
  "descriptionGenerated": zod.boolean().optional().describe('True when description is an AI-generated stand-in because no legible box-back text was found (false for manual, verbatim, or catalog text).'),
  "acquiredAt": zod.string().nullish(),
  "dominantColors": zod.array(zod.string()).optional(),
  "motifs": zod.array(zod.string()).optional(),
