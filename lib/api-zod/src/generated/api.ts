...
export const SendPhoneVerificationCodeResponse = zod.void()
 ...
 */
export const SendTestSmsResponse = zod.void()


/**
 * @summary Send a test email to the current user's own account email
 */
export const SendTestEmailResponse = zod.void()
...
export const CreatePotteryResponse = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "quantity": zod.number().min(1),
  "lockedFields": zod.array(zod.string()),
...
export const DeletePotteryResponse = zod.void()
...
export const AddPotteryImageResponse = zod.object({
  "id": zod.number(),
  "url": zod.string(),
  "label": zod.string().nullish(),
  "position": zod.number()
...
export const DeletePotteryImageResponse = zod.void()
...
export const CreatePotteryCategoryResponse = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "bgColor": zod.string().nullish(),
  "textColor": zod.string().nullish(),
...
export const DeletePotteryCategoryResponse = zod.void()
...
export const MergePotteryCategoryResponse = zod.void()
...
export const GetFabricImageResponse = zod.unknown()
...
export const AddFabricImageResponse = zod.object({
  "id": zod.number(),
  "url": zod.string(),
  "label": zod.string().nullish(),
  "position": zod.number()
...
export const GetFabricSupplementalImageResponse = zod.unknown()
...
export const DeleteFabricImageResponse = zod.void()
...
export const CreatePatternResponse = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "designer": zod.string().nullish(),
  "blockSize": zod.string().nullish(),
...
export const DeletePatternResponse = zod.void()
...
export const GetPatternImageResponse = zod.unknown()
...
export const AddPatternImageResponse = zod.object({
  "id": zod.number(),
  "url": zod.string(),
  "label": zod.string().nullish(),
  "position": zod.number()
...
export const GetPatternSupplementalImageResponse = zod.unknown()
...
export const DeletePatternImageResponse = zod.void()
...
export const createQuiltResponseCompletionPercentageMin = 0;
export const createQuiltResponseCompletionPercentageMax = 100;



export const CreateQuiltResponse = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "dateCompleted": zod.string().nullish(),
  "sizeWidth": zod.number().nullish(),
  ...
  "dominantColors": zod.array(zod.string()),
  "lockedFields": zod.array(zod.string()),
  "completionPercentage": zod.number().min(createQuiltResponseCompletionPercentageMin).max(createQuiltResponseCompletionPercentageMax).optional().describe('WIP completion 0–100. 0 = not started, 100 = finished.'),
  "categories": zod.array(zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "bgColor": zod.string().nullish(),
...
export const DeleteQuiltResponse = zod.void()
...
export const GetQuiltImageResponse = zod.unknown()
...
export const AddQuiltImageResponse = zod.object({
  "id": zod.number(),
  "url": zod.string(),
  "label": zod.string().nullish(),
  "position": zod.number()
...
export const GetQuiltSupplementalImageResponse = zod.unknown()
...
export const DeleteQuiltImageResponse = zod.void()
...
export const CreateQuiltingCategoryResponse = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "bgColor": zod.string().nullish(),
  "textColor": zod.string().nullish()
...
export const DeleteQuiltingCategoryResponse = zod.void()
...
export const createLayoutResponseSashingWidthInchesMin = 0;
export const createLayoutResponseSashingWidthInchesMax = 6;

export const createLayoutResponseBorderWidthInchesMin = 0;
export const createLayoutResponseBorderWidthInchesMax = 6;
...
export const CreateLayoutResponse = zod.object({
  ...
  "dominantColors": zod.array(zod.string()).describe('Hex colours extracted from sashing\/border\/block cells, sorted by frequency'),
  "sashingWidthInches": zod.number().min(createLayoutResponseSashingWidthInchesMin).max(createLayoutResponseSashingWidthInchesMax).nullish().describe('Sashing strip width in inches (null = no sashing)'),
  "sashingColor": zod.string().nullish().describe('Hex colour for sashing strips'),
  "borderWidthInches": zod.number().min(createLayoutResponseBorderWidthInchesMin).max(createLayoutResponseBorderWidthInchesMax).nullish().describe('Outer border width in inches (null = no border)'),
  "borderColor": zod.string().nullish().describe('Hex colour for outer border'),
  "cornerstoneColor": zod.string().nullish().describe('Hex colour for cornerstone squares at sashing intersections (null = no cornerstones)'),
  "createdAt": zod.coerce.date(),
  "categories": zod.array(zod.object({
...
export const GetBlockPreviewPngResponse = zod.unknown()
...
export const CreateBlockTemplateResponse = zod.object({
  "id": zod.number(),
  "createdByUserId": zod.number().nullish(),
  "name": zod.string(),
  "tags": zod.array(zod.string()),
...
export const DeleteBlockTemplateResponse = zod.void()
...
export const CreatePatternVariantResponse = zod.object({
  "id": zod.number(),
  "patternId": zod.number(),
  "name": zod.string(),
  "finishedWidth": zod.number().nullish(),
...
export const DeletePatternVariantResponse = zod.void()
...
export const RunPatternAnalysisResponse = zod.object({
  "id": zod.number(),
  "patternId": zod.number(),
  "variantId": zod.number().nullish(),
  "status": zod.enum(['running', 'done', 'failed']),
...
export const AddFabricIdentifierResponse = zod.object({
  "id": zod.number(),
  "fabricId": zod.number(),
  "identifierType": zod.enum(['sku', 'selvedge', 'barcode', 'other']),
  "value": zod.string(),
...
export const DeleteFabricIdentifierResponse = zod.void()
...
export const RunFabricIdentityResearchResponse = zod.object({
  "id": zod.number(),
  "fabricId": zod.number(),
  "status": zod.enum(['running', 'done', 'failed']),
  "candidates": zod.array(zod.object({
...
export const UploadTripDocumentResponse = zod.object({
  "id": zod.number(),
  "tripId": zod.number().nullish(),
  "userId": zod.number(),
  "storagePath": zod.string(),
...
export const DeleteTripDocumentResponse = zod.void()
...
export const DownloadTripDocumentResponse = zod.unknown()
...
export const DeleteUnmatchedDocumentResponse = zod.void()
...
export const BulkCreatePackingItemsResponseItem = zod.object({
  "id": zod.number(),
  "listId": zod.number(),
  "text": zod.string(),
  "packed": zod.boolean(),
...
export const BulkCreatePackingItemsResponse = zod.array(BulkCreatePackingItemsResponseItem)
...
export const DeletePackingItemResponse = zod.void()
...
export const LoadPackingTemplateResponse = zod.object({
  "added": zod.number(),
  "items": zod.array(zod.object({
  "id": zod.number(),
  "listId": zod.number(),
...
export const CreatePackingTemplateResponse = zod.object({
  "id": zod.number(),
  "userId": zod.number(),
  "name": zod.string(),
  "items": zod.array(zod.string()),
...
export const DeletePackingTemplateResponse = zod.void()
...
export const TravelsCreateReservationResponse = zod.object({
  "id": zod.number(),
  "tripId": zod.number(),
  "documentId": zod.number().nullish(),
  "reservationType": zod.enum(['flight', 'hotel', 'rental_car', 'rail', 'general']),
...
export const TravelsDeleteReservationResponse = zod.void()
...
export const CreateOrnamentResponse = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "brand": zod.string(),
  "seriesOrCollection": zod.string().nullish(),
...
export const DeleteOrnamentResponse = zod.void()
...
export const AddOrnamentImageResponse = zod.object({
  "id": zod.number(),
  "url": zod.string(),
  "label": zod.string().nullish(),
  "position": zod.number()
...
export const DeleteOrnamentImageResponse = zod.void()
...
export const CreateOrnamentCategoryResponse = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "bgColor": zod.string().nullish(),
  "textColor": zod.string().nullish(),
...
export const DeleteOrnamentCategoryResponse = zod.void()
...
export const MergeOrnamentCategoryResponse = zod.void()
...
export const AddReactionResponse = zod.void()
...
export const RemoveReactionResponse = zod.void()
...
export const PushSubscribeResponse = zod.void()
 ...
 */
export const ExportOperationEventsResponse = zod.unknown()
