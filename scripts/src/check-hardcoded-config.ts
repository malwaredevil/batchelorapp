...
export const HARDCODED_CONFIG_ALLOWLIST: ReadonlySet<string> = new Set([
  ...
  "artifacts/api-server/src/elaine/index.ts:10271", // MAX_ROUNDS (restricted-channel OpenAI-Responses attempt loop)
  "artifacts/api-server/src/elaine/index.ts:10533", // MAX_ROUNDS (restricted-channel reply loop, SMS/email/Slack)
  ...
  "artifacts/api-server/src/lib/comm-check-scheduler.ts:307",
  ...
  "artifacts/api-server/src/lib/reminders-scheduler.ts:417",
  ...
  "lib/elaine-ui/src/ElaineWidget.tsx:35",
