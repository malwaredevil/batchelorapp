...
const DIRECT_TOOL_MAP: Record<string, string[]> = {
  ...
  listDiaryEntries: ["query_household_data", "search_household_data"],
  createDiaryEntry: ["add_diary_entry"],
  updateDiaryEntry: ["edit_diary_entry"],
  deleteDiaryEntry: ["delete_diary_entry"],
  ...
  listMagnets: ["discover_app_operations", "execute_app_operation"],
  getMagnet: ["discover_app_operations", "execute_app_operation"],
  updateMagnet: ["update_magnet_item"],
  deleteMagnet: ["delete_magnet_item"],
  reanalyzeMagnet: ["reanalyze_magnet"],
  listMagnetCategories: ["discover_app_operations", "execute_app_operation"],
  createMagnetCategory: ["create_magnet_category"],
  renameMagnetCategory: ["rename_magnet_category"],
  deleteMagnetCategory: ["delete_magnet_category"],
  mergeMagnetCategory: ["merge_magnet_categories"],
  deleteMagnetImage: ["delete_magnet_photo"],
  setMagnetPrimaryImage: ["promote_magnet_photo"],
