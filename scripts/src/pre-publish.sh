...
echo "  │              suggestions. Run once per push before waiting for reviews.    │"
echo "  │                                                                             │"
echo "  │   Step B — wait for ALL bot reviews to finish (each is async):            │"
...
echo "  │              AND re-triggers bot reviews (both bots re-review on promotion)│"
