...
echo "  │           Exception: within the Stage 3c2 loop, Step C fix commits        │"
echo "  │           are pushed BEFORE their threads are resolved (Step E). The      │"
echo "  │           zero-threads requirement applies at the START of a new cycle,   │"
echo "  │           not as a blocker for the follow-up commits inside the loop.     │"
