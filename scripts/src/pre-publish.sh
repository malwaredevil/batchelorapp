...
echo "  │ Stage 3c2 — Bot review loop (REQUIRED — Copilot AND Codex are both mandatory  │"
echo "  │              reviewers; treat EVERY bot comment as a validation that must  │"
echo "  │              pass before merging. If additional reviewer bots are added in  │"
echo "  │              future, expand the expected-reviewer set below explicitly —   │"
echo "  │              do NOT rely on 'count >= 2'; wait for every named reviewer):  │"
echo "  │                                                                             │"
...
echo "  │              Do NOT proceed until BOTH bots have posted.                  │"
echo "  │                                                                             │"
...
echo "  │              (re-trigger Codex; wait for both bots on the new HEAD).      │"
echo "  │                                                                             │"
