...
echo "  │              Only count reviews whose submitted_at is AFTER the current    │"
echo "  │              push's pushed_at timestamp — stale reviews from prior         │"
echo "  │              commits must not satisfy this gate.                           │"
...
echo "  │              A pushed follow-up resets CI — loop back to Step B.           │"
echo "  │                                                                             │"
...
echo "  │              ② Bots — repeat Stage 3c2 Steps A-E for any new comments     │"
echo "  │                      posted by Copilot/Codex after promotion.             │"
echo "  │                      Re-trigger Codex manually after promotion too        │"
