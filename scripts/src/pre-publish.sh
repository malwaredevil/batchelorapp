...
echo "  │              Poll GET /repos/.../pulls/:pr/reviews, filter to             │"
...
echo "  │              If apply-pr-suggestions pushes a commit: reply to each        │"
echo "  │              auto-applied suggestion comment (\"Applied in commit <sha>\") │"
echo "  │              and resolve its thread via Steps D-E, THEN loop back to     │"
echo "  │              Step A. Do not skip Steps D-E — otherwise the next review   │"
echo "  │              cycle inherits unresolved threads from the applied commits.  │"
echo "  │                                                                             │"
echo "  │   Step C — address every inline comment (NO exceptions):                  │"
echo "  │              GET /repos/.../pulls/:pr/comments                             │"
