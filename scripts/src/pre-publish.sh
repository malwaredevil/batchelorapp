...
echo "  │              pass before merging. Future bot reviewers are included         │"
echo "  │              automatically — detect by user.type=Bot, not by login name):  │"
echo "  │                                                                             │"
...
echo "  │              Known reviewer bots:                                           │"
echo "  │                copilot-pull-request-reviewer[bot]  (Copilot — auto)       │"
echo "  │                chatgpt-codex-connector[bot]        (Codex — manual)       │"
echo "  │              Copilot triggers automatically on every push.                 │"
echo "  │              Codex does NOT auto-trigger — ALWAYS post a manual trigger:  │"
