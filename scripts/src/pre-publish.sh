...
echo "  │              Copilot reviews drafts automatically; do NOT manually trigger  │"
echo "  │              Codex during draft work. Treat EVERY bot comment as a          │"
...
echo "  │      2. Required reviews have completed at their configured cadence:       │"
echo "  │           Copilot's draft automation before promotion; one Codex request  │"
echo "  │           at the initial promotion. A later fix push does NOT reset the   │"
echo "  │           Codex gate or require a new manual request.                      │"
...
echo "  │    consolidated commit. Pushing early restarts CI and may re-trigger bots │"
...
echo "  │                dependabot[bot], github-actions[bot],                       │"
echo "  │                github-advanced-security[bot], github-codeql[bot]           │"
echo "  │              Match reviews to the draft/promotion event that requested    │"
echo "  │              them. A follow-up fix push does not invalidate the initial   │"
echo "  │              promotion's Codex review. Wait for any active request to be  │"
echo "  │              COMMENTED or APPROVED (not PENDING). Allow ~5 min.            │"
...
echo "  │              Copilot is configured to review draft PRs, not new pushes.   │"
echo "  │              During draft work, wait for its automatic review only.       │"
echo "  │              At the FIRST Draft → Ready-for-review transition, post the   │"
echo "  │              ONE manual Codex request; never re-trigger Codex after later │"
echo "  │              pushes or fixes in this PR. At that promotion, post:          │"
...
echo "  │              (Copilot during draft; both after initial promotion).        │"
echo "  │                                                                             │"
...
echo "  │              (do not re-trigger Codex; follow the configured Copilot      │"
echo "  │               review cadence for subsequent pushes).                       │"
echo "  │                                                                             │"
...
echo "  │              Record the PR head SHA immediately before promotion; it is   │"
echo "  │              the promotion-head SHA used to identify the one Codex review. │"
echo "  │              Copilot follows its configured automation; post the ONE      │"
echo "  │              @codex comment manually at this first promotion only.         │"
...
echo "  │                        GET /repos/.../issues/:pr/timeline?per_page=100;  │"
echo "  │                        follow every Link-header next page, find event=    │"
echo "  │                        ready_for_review, and use its created_at           │"
echo "  │                      Accept the one Codex review with commit_id equal to │"
echo "  │                      the recorded promotion-head SHA AND submitted_at >=  │"
echo "  │                      promotion created_at. It remains valid after later   │"
echo "  │                      follow-up fixes; do not demand a new Codex review.   │"
echo "  │                      Then run                                             │"
echo "  │                      Steps B-E for any new post-promotion comments.       │"
echo "  │                      Do not re-trigger Codex after later fix pushes; the  │"
echo "  │                      initial promotion request is the only manual ask.    │"
