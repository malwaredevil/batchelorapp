...
const TEMPLATES: TemplateDef[] = [
  ...
  // ── New additions ─────────────────────────────────────────────────────────
  t("Half Square Triangle", ["Beginner", "Basic"], 1, 1, [nwse(LIGHT, DARK)]),
  t("Snowball", ["Traditional", "Beginner"], 3, 3, [
    nesw(LIGHT, DARK),
    solid(DARK),
    nwse(LIGHT, DARK),
    solid(DARK),
  ...
  t("Attic Window", ["Traditional", "Frame"], 2, 2, [
    solid(DARK),
    solid(GOLD),
    solid(GOLD),
    solid(LIGHT),
  ]),
  t("Cross and Crown", ["Traditional", "Nine Patch"], 3, 3, [
    nesw(LIGHT, GOLD),
    solid(DARK),
    nwse(LIGHT, GOLD),
    solid(DARK),
  ...
  t("Double Four Patch", ["Four Patch", "Beginner"], 4, 4, [
    solid(DARK),
    solid(LIGHT),
    solid(LIGHT),
    solid(DARK),
  ...
  t("T-Block", ["Traditional", "Nine Patch"], 3, 3, [
    solid(DARK),
    solid(DARK),
    solid(DARK),
    solid(LIGHT),
  ...
  t("Aunt Sukey's Choice", ["Traditional", "Nine Patch"], 3, 3, [
    nwse(LIGHT, DARK),
    solid(GOLD),
    nesw(LIGHT, DARK),
    solid(GOLD),
